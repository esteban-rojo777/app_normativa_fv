...
from langchain.prompts import PromptTemplate # <-- IMPORTACI車N NUEVA
...
def cargar_y_procesar_documentos(ruta_documentos):
    ...
    st.success("?Base de datos vectorial creada y guardada con 谷xito!")
    return vectordb
                ...
                try:
                    ...
                    with st.expander("Ver fuentes utilizadas en la normativa"):
                        for doc in respuesta["source_documents"]:
                            ...
                            st.info(f"**Fuente:** {nombre_archivo} | **P芍gina:** {doc.metadata.get('page', 'N/A') + 1}")
